...
function highlite_match(p1, pos) {
  return "<span style='font-weight:bold;color:Blue;'>" + p1 + "</span>"
			...
			$this.append('<input class="autocomplete" title="type &quot;a&quot;">')
$this.append('<div class="autocomplete_full_description" style="width:50%"><div>')
$this.find(".autocomplete").on('focus', function(){
	$this.find(".autocomplete").select()
})
...
$this.find('.autocomplete').search_terms({
	minLength:0,
	maxResults: 10,
